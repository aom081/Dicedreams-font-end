...
function EventCard(props) {
    ...
    const handleEndPost = async () => {
        try {
            ...
            await axios.put(`https://dicedreams-backend-deploy-to-render.onrender.com/api-docs/postGame/${eventId}`, {
    ...
    useEffect(() => {
        const fetchUserDetails = async (id) => {
            try {
                const response = await axios.get(`https://dicedreams-backend-deploy-to-render.onrender.com/api-docs/users/${id}`, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                    },
                });
